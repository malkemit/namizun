...
cd /var/www/namizun && source /var/www/namizun/venv/bin/activate && pip install wheel -i https://pypi.tuna.tsinghua.edu.cn/simple/ && pip install -i https://pypi.tuna.tsinghua.edu.cn/simple/ namizun_core/ namizun_menu/ && deactivate
if [ $? != 0 ]; then
