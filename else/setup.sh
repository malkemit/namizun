...
cd /var/www/namizun && source /var/www/namizun/venv/bin/activate && pip install wheel -i http://pypi.douban.com/simple/ --trusted-host pypi.douban.com && pip install -i https://pypi.tuna.tsinghua.edu.cn/simple/ namizun_core/ namizun_menu/ && deactivate
if [ $? != 0 ]; then
